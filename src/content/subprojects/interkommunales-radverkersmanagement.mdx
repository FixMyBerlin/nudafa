...
Mit dem “Interkommunale Radverkehrsmanagement” (IRVM) sollte erprobt werden, wie mit einer auf kommunaler Ebene angesiedelten Organisationseinheit die Radverkehrsförderung mehrerer Kommunen gebündelt werden kann. Drei Fragestellung stehen dabei im Fokus:
...
2. Damit verbunden war die vorbereitende Institutionalisierung des IRVM über die Laufzeit des Reallabors hinaus.&#x20;
3. Darüber hinaus sollten die erarbeiteten Formen und Angebote zur interkommunalen Zusammenarbeit in der Radverkehrsförderung so bearbeitet werden, dass diese auf andere Kommunen übertragen und als Handreichungen genutzt werden können.
