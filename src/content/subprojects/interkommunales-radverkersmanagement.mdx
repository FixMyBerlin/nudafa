...
<ImageDouble
  src="/src/assets/subprojects/interkommunales-radverkersmanagement/GemeinsameStellungnahme1x1.png"
  caption="Gemeinsame Stellungnahme an den Landkreis"
  srcSecond="/src/assets/subprojects/interkommunales-radverkersmanagement/IKR_Antrag_1x1.png"
  captionSecond="Antragstellung die Planung eines Radwegs durch vier Kommunen"
...
<ImageDouble
  src="/src/assets/subprojects/interkommunales-radverkersmanagement/230902_003unbenannt.jpg"
  caption="Erfassung von Handlungsbedarfen beim Stadtfest in Schönefeld"
  srcSecond="/src/assets/subprojects/interkommunales-radverkersmanagement/220507_013_GRIII.jpg"
  captionSecond="Erfassung von Handlungsbedarfen beim Tag der Mobilität in Eichwalde"
  imageConfig={{ discriminant: 'square' }}
/>
