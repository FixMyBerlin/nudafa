...
teaserImageCopyright: Markus Distelrath
topics:
  - foerdermittelaquise
  - gemeinsame-vergabe
  - infrastruktur
...
---
###### Realexperiment · Interkommunale Kooperationen · Instrumente der Radverkehrsförderung
...
<ImageDouble src="/src/assets/subprojects/interkommunales-radverkersmanagement/GemeinsameStellungnahme.png" caption="Gemeinsame Stellungnahme an den Landkreis" srcSecond="/src/assets/subprojects/interkommunales-radverkersmanagement/IKR_Antrag.png" captionSecond="Antragstellung die Planung eines Radwegs durch vier Kommunen" imageConfig={{"discriminant":"vertical","value":"4/3"}} />
