...
<ImageDouble
  src="/src/assets/subprojects/komfortables-kopfsteinpflaster/210222-016.jpg"
  caption="Für Eichwalde ortsbildprägendes Natursteinpflaster "
  srcSecond="/src/assets/subprojects/komfortables-kopfsteinpflaster/210222-015.jpg"
  captionSecond="In-Situ geschliffenes Kopfsteinpflaster als Ergebnis eines ersten Experiments"
...
<ImageDouble
  src="/src/assets/subprojects/komfortables-kopfsteinpflaster/IMG_20201208_10024811.jpg"
  caption="Die Schleifmaschine mit einer Diamant-Schleifwalze"
  srcSecond="/src/assets/subprojects/komfortables-kopfsteinpflaster/Untitled.png"
  captionSecond="Beispiel eines Radweges aus wasserdurchlässigem Material"
  imageConfig={{ discriminant: 'square' }}
/>
