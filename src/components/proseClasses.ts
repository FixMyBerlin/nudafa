...
export const markdownProseClasses = clsx(
  ...
  'prose-a:underline prose-a:decoration-beige-600 prose-a:decoration-[1.5px] prose-a:underline-offset-2 hover:prose-a:text-beige-600 prose-a:active:decoration-2',
