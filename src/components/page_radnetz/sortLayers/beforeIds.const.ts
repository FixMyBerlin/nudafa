...
export const beforeIds: Record<LayerKey, BelowLayerKey> = {
  ...
  'maskierung-boundary-nudafa-maskierung-boundary': 'nudafa-boundaries-gemeinden',
  // Pages
  ...
  'bestand-bikelanes-nudafa-bikelanes-fuehrungmitfuss': 'bestand-bikelanes-nudafa-bikelanes-seperateinfra',
  ...
  'komfort-roads-smoothness-roads-all': 'bestand-bikelanes-nudafa-bikelanes-seperateinfra',
  ...
  'luftliniennetz-netzentwurf-nudafa-zielpunkte': 'luftliniennetz-netzentwurf-nudafa-luftlininien',
