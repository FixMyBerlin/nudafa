...
export const beforeIds: Record<LayerKey, BelowLayerKey> = {
  ...
  'luftliniennetz-zielzwang-zielpunkte': 'luftliniennetz-combined-Luftlinien',
  'luftliniennetz-zielzwang-zwangspunkte': 'luftliniennetz-zielzwang-zielpunkte',
  ...
  'zielnetz-netzentwurf-nudafa-netzentwurf': 'luftliniennetz-zielzwang-zwangspunkte',
